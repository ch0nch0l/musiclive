    ...
    <!-- /w3l-agileits -->
      <!-- //header-ends -->
          <div id="page-wrapper">
              ...
              <link href="{{asset('website/css/jplayer.blue.monday.min.css')}}" rel="stylesheet" type="text/css">
              <script type="text/javascript" src="{{asset('website/js/jquery.jplayer.min.js')}}"></script>
              <script type="text/javascript" src="{{asset('website/js/jplayer.playlist.min.js')}}"></script>
              <script type="text/javascript">
              //<![CDATA[
              $(document).ready(function(){
                  ...
                  new jPlayerPlaylist({
                      ...
                      
                      {
                          ...
                          artist:"",
                          mp4: "website/video/Ellie-Goulding.mp4",
                          ogv: "website/video/Ellie-Goulding.ogv",
                          webmv: "website/video/Ellie-Goulding.webm",
                          poster:"website/video/play1.png"
                      },
                      {
                          title:"2. Mark-Ronson-Uptown",
                          artist:"",
                          mp4: "website/video/Mark-Ronson-Uptown.mp4",
                          ogv: "website/video/Mark-Ronson-Uptown.ogv",
                          webmv: "website/video/Mark-Ronson-Uptown.webm",
                          poster:"website/video/play2.png"
                      },
                      {
                      ...
                      },
                      {
                          ...
                          artist:"",
                          mp4: "website/video/Maroon-Sugar.mp4",
                          ogv: "website/video/Maroon-Sugar.ogv",
                          webmv: "website/video/Maroon-Sugar.webm",
                          poster:"website/video/play4.png"
                      },
                      {
                          title:"5. Pharrell-Williams",
                          artist:"",
                          mp4: "website/video/Pharrell-Williams.mp4",
                          ogv: "website/video/Pharrell-Williams.ogv",
                          webmv: "website/video/Pharrell-Williams.webm",
                          poster:"website/video/play5.png"
                      },
                      {
